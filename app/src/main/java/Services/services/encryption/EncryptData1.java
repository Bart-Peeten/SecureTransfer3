package Services.services.encryption;
...
public class EncryptData1 {

    private Cipher cipher;

    public EncryptData1(File originalFile, File encrypted, SecretKeySpec secretKey, String cipherAlgorithm)
